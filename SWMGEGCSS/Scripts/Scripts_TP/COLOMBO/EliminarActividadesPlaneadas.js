    ...
    var envioajaxModal = function () {
        $(this).click(function () {
            ...
            $.ajax({
                ...
                $(modal).modal();
                $(".btnEliminarPlanAct").click(envioajaxEliminar);
            });
            return false;
        });
    };
    var envioajaxEliminar = function () {
        //mismo nombre del parametro de actualizacion del metodo
        //creando objeto
        
        $.ajax({
            url: "/Plan/_ModalEliminarActividadesPlanificadasFinal",
            method: "POST",
            data: {
                act_plan_id: id_plan
            }
